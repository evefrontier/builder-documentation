# deploy smart turret contracts

Firstly, you need to deploy the **Smart Turret** Contracts to the world for them to work.

### Deploy the smart turret contracts to the world
...
Next, set the following values in the [.env](/broken/pages/50bbfc8827df513f1b3a68207bbca9c6ed7bb3b1) file to direct the scripts to use OP Sepolia:
...
Then, set the **PRIVATE\_KEY** in your .env file. Example excerpt:
...
{% code title="smart-turret/packages/contracts/src/systems/constants.sol" %}
```
```
{% endcode %}
