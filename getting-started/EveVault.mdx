...
EVE Vault houses your EVE Tokens and allows you to link your character’s account to player-made DApps, safeguarding your infomorph's identity should your clone body be destroyed. It is overseen by Keeper, an autonomous agent residing in the EVE Protocol.

- **The EVE Token**: a fixed-volume ERC-20 utility token designed to foster an inclusive business model and ecosystem for third-party developers/modders. The EVE Token will exist in a test environment until after the full consumer launch of EVE Frontier. Note: all test EVE Tokens will be wiped from each playtest and will not carry forward.

The economy of EVE Frontier is designed to allow for real-world value to be exchanged for in-game value and vice-versa.
...
- LUX: used for in-game transactions. For example, LUX can be used to purchase things from the in-game market, station services, trades between players etc.

- EVE Token: a utility token that can be exchanged as a means of value and to obtain additional Mining Lenses.
