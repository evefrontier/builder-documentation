...
* Follow the [Tools guide](https://github.com/evefrontier/builder-documentation/blob/Main/Tools/README.md) to set up your SUI development environment and all necessary dependencies.
* Deploy or connect to an EVE Frontier World instance as described in the [World Setup guide](https://github.com/evefrontier/builder-documentation/blob/Main/LocalWorldSetup/README.md).
