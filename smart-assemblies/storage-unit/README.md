...
* Follow the [Tools guide](https://github.com/evefrontier/builder-documentation/blob/Main/Tools/README.md) to set up your SUI development environment and required dependencies.
* Deploy or connect to an EVE Frontier World instance using the [World Setup guide](https://github.com/evefrontier/builder-documentation/blob/Main/LocalWorldSetup/README.md).
